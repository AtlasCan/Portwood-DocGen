...
function fix(file, isAdmin) {
    let xml = fs.readFileSync(file, 'utf8');
    
    // Safety check - if it already contains the object, skip
    if (xml.includes('DocGen_Signature_Request__c')) return;
...
fix('force-app/main/default/permissionsets/DocGen_Admin.permissionset-meta.xml', 'true');
fix('force-app/main/default/permissionsets/DocGen_User.permissionset-meta.xml', 'false');
